...
/mob/living/carbon/alien/humanoid/ant/queen/can_inject(mob/user, error_msg, target_zone, penetrate_thick)
	return FALSE

//Queen verbs
/mob/living/carbon/alien/humanoid/ant/queen/verb/lay_egg()

	set name = "Lay Egg (75)"
	set desc = "Lay an egg to produce larva."
	set category = "Alien"
	if(locate(/obj/effect/mob_spawn/ant_egg) in get_turf(src))
	...
	if(powerc(75,1))//Can't plant eggs on spess tiles. That's silly.
		...
		new /obj/effect/mob_spawn/ant_egg(loc)
	return


/mob/living/carbon/alien/humanoid/ant/queen/large
	icon = 'icons/mob/alienlarge.dmi'
	icon_state = "queen_s"
	pixel_x = -16
	large = 1

/mob/living/carbon/alien/humanoid/ant/queen/large/update_icons()
	overlays.Cut()
