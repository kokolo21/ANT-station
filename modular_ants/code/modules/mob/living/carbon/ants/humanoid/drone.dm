/mob/living/carbon/alien/humanoid/ant/drone
	name = "ant drone"
	caste = "d"
	maxHealth = 100
	health = 100
	icon = 'modular_ants/icons/mob/ants.dmi'
	icon_state = "antd_s"

/mob/living/carbon/alien/humanoid/ant/drone/Initialize(mapload)
	. = ..()
	if(src.name == "ant drone")
		src.name = "ant drone ([rand(1, 1000)])"
	src.real_name = src.name

/mob/living/carbon/alien/humanoid/ant/drone/get_caste_organs()
	. = ..()
	. += list(
...
/mob/living/carbon/alien/humanoid/ant/drone/verb/evolve() // -- TLE
	set name = "Evolve (500)"
